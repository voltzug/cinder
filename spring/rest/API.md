...
curl -X POST http://localhost:8088/api/alpha/upload \
  ...
  -F "gateHash=$(echo -n 'gate-hash-bytes' | base64)" \
...
curl -X GET "http://localhost:8088/api/alpha/download/LK12345678-1234-1234-1234-123456789abc/init"
```
