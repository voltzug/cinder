...
/**
 * Random salt used for client-side key derivation
 */
public final class Salt extends SafeBlobSized {

  /** 64b */
  private static final int _SIZE_BASE = 8;
  /** 128b */
  public static final int SIZE_MIN = 16;
  /** 512b */
   ...
   */
  public Salt(final byte[] value, int size) {
