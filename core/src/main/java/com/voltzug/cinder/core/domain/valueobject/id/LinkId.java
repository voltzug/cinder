 ...
 */
public final class LinkId extends Id {

  public static final IdPrefix PREFIX = IdPrefix.LINK;

  public LinkId(final String value) {
    super(value, PREFIX);
  }

  public static LinkId generate() {
    return new LinkId(UUID.randomUUID().toString());
  }
}
